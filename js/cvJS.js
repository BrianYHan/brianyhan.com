$(document).ready(function(){
  $('#interactiveCV h3').click(function(){
    console.log('click');
    var cvCategory = $(this).attr('cvCategory');
    $('#interactiveCV div').each(function(){
      if($(this).hasClass(cvCategory)){
        $(this).toggle('slow');
      }
    });
...
//Hides CV
  ...
  $('#interactiveCV h3').hover(function(){
